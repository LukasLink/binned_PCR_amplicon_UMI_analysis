...
# Directories
output_folder   <- "/g/steinmetz/xie/CRISPRscreen-Output-2025.08.08updated"
...
method              <- "sum"    # can be "rep", "rep_sample", "rep_sublib", "sum" or ""
...
min_guides_per_gene <- 3 # Minimum number of guides required to detect a gene.
...
file_suffix <- paste0("_", pipeline,
                      "_", data_type,
                      "_", method,
                      "_", norm_method,
                      "_", recover_input_suffix,
                      "_", drop_0s_suffix,
                      "_", strict_mode_suffix,
                      "_", min_guides_per_gene,
                      "_", extra_suffix,
                      ".rds")
file_suffix <- sub("___","_",file_suffix)
file_suffix <- sub("__","_",file_suffix)
file_suffix <- sub("_\\.","\\.",file_suffix)
file_info_suffix <- paste0(pipeline, "_", data_type, "_", method, "_", norm_method, recover_input_suffix, drop_0s_suffix,"_", extra_suffix)
file_info_suffix <- sub("___","_",file_info_suffix)
file_info_suffix <- sub("__","_",file_info_suffix)
file_info_suffix <- sub("_$", "", file_info_suffix)
...
and to troubleshoot it if things fail. 
...
Hits_lukas_reads_rep_RI <- add_info_wrapper("lukas_reads_rep_RI")
Hits_lukas_reads_sum_RI <- add_info_wrapper("lukas_reads_sum_RI")
Hits_lukas_reads_control_median_RI <- add_info_wrapper("lukas_reads_control_median_RI")
Hits_lukas_reads_sum_control_median_RI <- add_info_wrapper("lukas_reads_sum_control_median_RI")
