...
# Directories
output_folder   <- "/g/steinmetz/link/Liangfu_iBeer/cor_combined/"
...
skip_list <- c(
  "I_L1_20802",
  "I_L1_20811", "I_L1_20813", "I_L1_20704", "I_L1_30802", "I_L1_30811",
  "I_L1_30813", "I_L1_30704", 
  "I_L3_20802", "I_L3_20811", "I_L3_20813", "I_L3_20704",
  "I_L3_30802", "I_L3_30811", "I_L3_30813", "I_L3_30704", "I_L5_10802",
  "I_L5_20802", "I_L5_20811",
  "I_L5_20813", "I_L5_20704", "I_L5_30802", "I_L5_30811", "I_L5_30813",
  "I_L5_30704", "I_L6_20811",
  "I_L6_20813", "I_L6_20704", "I_L6_30811", "I_L6_30813", "I_L6_30704",
  "L_L1_120813", "L_L1_120704", "L_L1_20813",
  "L_L1_20704", "L_L1_30813", "L_L1_30704", "L_L3_120811",
  "L_L3_120813", "L_L3_120704", "L_L3_20813", "L_L3_20704",
  "L_L3_30813", "L_L3_30704", "L_L5_120813", "L_L5_120704",
  "L_L5_20813", "L_L5_20704", "L_L5_30813", "L_L5_30704",
  "L_L6_120813", "L_L6_120704", "L_L6_20813",
  "L_L6_20704", "L_L6_30813", "L_L6_30704", "U_L1_120813",
  "U_L1_120704", "U_L1_20813", "U_L1_20704", "U_L1_30813",
  "U_L1_30704",  "U_L3_120813", "U_L3_120704",
  "U_L3_20813", "U_L3_20704", "U_L3_30813", "U_L3_30704",
  "U_L5_120813", "U_L5_120704", "U_L5_20813",
  "U_L5_20704", "U_L5_30813", "U_L5_30704","U_L6_120813",
  "U_L6_120704", "U_L6_20813", "U_L6_20704", "U_L6_30813",
  "U_L6_30704", "I_L3_10802", "U_L3_10802","U_L3_10811",
  "I_L1_10811","I_L1_10802","I_L6_10811","I_L5_10811","I_L3_10811"
)
...
method              <- "rep_sublib"    # can be "rep", "rep_sample", "rep_sublib", "sum" or ""
...
strict_mode <- TRUE # bolean, removes all guides which don't have UMIs for all bins. 
min_guides_per_gene <- 2 # Minimum number of guides required to detect a gene, per replicate not total
auto_combine_replicates <- TRUE # automatically combines replicas
...
generate_all_violin_plots_and_summaries(count_df_long, y_limit = 5, non_targeting = TRUE)
generate_all_violin_plots_and_summaries(count_df_long, norm_method = "control_median", y_limit = 6, non_targeting = TRUE) 
...
Hits_default <- add_info_wrapper("lukas_umis_control_median_RI")
...
top_100 <- get_top_N_intersect(top_100_umis_intersect,Hits_sublib, N=100)
...
plot_significance_by_rank <- function(Hits_df,
  ...
  if (mark_cntrl && "symbol" %in% names(Hits_df)) {
    p <- p + geom_point(
      ...
      annotate("rect",
               xmin = max(Hits_df$rank) - 3000,
               xmax = max(Hits_df$rank) - 0,
               ymin = min(Hits_df$significanceZ) + 0.2,
               ymax = min(Hits_df$significanceZ) + 0.7,
               fill = "white", color = "black", size = 0.3) +
      annotate("point",
               x = max(Hits_df$rank) - 2800,
               y = min(Hits_df$significanceZ) + 0.45,
               color = "blue", size = 2) +
      annotate("text",
               x = max(Hits_df$rank) - 2600,
               y = min(Hits_df$significanceZ) + 0.45,
               label = "control sgRNA", hjust = 0, size = 3)
  }

  # Mark special symbol
  if (!is.null(mark_special) && "symbol" %in% names(Hits_df)) {
    special_df <- Hits_df %>% filter(symbol == mark_special)
    if (nrow(special_df) > 0) {
      p <- p +
        geom_point(data = special_df, aes(x = rank, y = significanceZ),
                   shape = 17, color = "orange", size = 4) +
        geom_text_repel(data = special_df,
...
excel_file_path <- sub("\\.rds$", ".xlsx", paste0(output_folder, "MAUDE_Hits", file_suffix))
write_xlsx(export_df, excel_file_path)
```

``` {r test, eval=FALSE}
imported_df <- read.csv("/g/steinmetz/link/Liangfu_iBeer/cor_combined/MAUDE_Hits_lukas_umis_rep_sublib_control_median_RI.csv", stringsAsFactors = FALSE, fileEncoding = "UTF-8")
excel_file_path <- sub("\\.rds$", ".xlsx", paste0("/g/steinmetz/link/Liangfu_iBeer/cor_combined/", "top_100.rds"))
write_xlsx(top_100, excel_file_path)
```
