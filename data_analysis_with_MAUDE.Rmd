...
norm_method         <- ""       # can be "control_median" or ""
...
file_suffix <- paste0("_", pipeline, "_", data_type, "_", method, norm_method, recover_input_suffix, drop_0s_suffix,"_", extra_suffix, ".rds")
