...
norm_method         <- ""       # can be "control_median" or "" currently broken!!! MAUDE returns NaN! -> set to ""
...
file_suffix <- paste0("_", pipeline, "_", data_type, "_", method, "_", norm_method, recover_input_suffix, drop_0s_suffix,"_", extra_suffix, ".rds")
...
maude_example_df_1 <- data.frame(sgRNA = c(LETTERS[1:6], "CONTROL_C_NONTARG_G", "CONTROL_C_NONTARG_H", "CONTROL_C_I", "CONTROL_C_J"),
                               input = c(4, 3, 5, 3, 8, 7, 5, 6, 7, 5),
                               upper = c(0, 9, 5, 0, 4, 2, 0, 1, 3, 2),
  ...
  top_hits_neg <- top_hits_df %>% filter(significanceZ < 0)
    ...
    p <- p +
      ...
      geom_text_repel(
        ...
        size = 3,
        box.padding = 0.8,       # space around the label box
...
plot_significance_by_rank(Hits_current_settings, mark_special = "AHSA1", mark_N_top_hits = 3)
