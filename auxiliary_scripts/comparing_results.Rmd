...
add_info_to_gene_stats <- function(maude_guide_stats, maude_gene_stats){
  ...
  HepG2_cpm_Xie <- readRDS("/g/steinmetz/link/Liangfu_Expression_Heatmaps/rds_files/hepato_df_cpm.rds")
...
high_confidence_hits <- automate_calc_replicate_comparison(FDR_threshold = 0.05,
                                                           ...
                                                           venn_diagram = FALSE)
inclusive_hits <- automate_calc_replicate_comparison(FDR_threshold = 0.05,
                                                     hits_in_X_reps = 10,
                                                     correlation_heatmap = FALSE,
                                                     venn_diagram = FALSE)
