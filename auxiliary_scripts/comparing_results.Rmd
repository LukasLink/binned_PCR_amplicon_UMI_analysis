...
user_opts <- list(
  ...
  # optional folders for results from bcwithqcs bcwithqc
  bcwithqc_rf_folder = "/g/steinmetz/link/Amplicon_barcode_analysis/NB_EXP030/bcwithqc_read_filt",
  bcwithqc_dir    = "",
  ...
  # Set Options for read_counting function
  read_counting                = "align_UMI_tools",          # can be "bcwithqc", "bcwithqc_rf" or "align_UMI_tools"
...
compare_bcwithqc_align_UMI_tools <- function(data_type,
                               bcwithqc_function = process_bcwithqc_data,
                               addage = "",
                               bcwithqc_dir = bcwithqc_dir,
                               align_UMI_tools_umi_folder = dedup_output_folder,
                               align_UMI_tools_read_folder = mapped_output_folder){
  ...
  bcwithqc_df_long <- bcwithqc_function(bcwithqc_dir,sgRNA_df, data_type = data_type, merged_sgRNA_df = merged_sgRNA_df)
  if (data_type == "umis"){
    align_UMI_tools_df_long <- process_folder_files(align_UMI_tools_umi_folder) #Add threshold df if thresholds should be applied
    data_name <- "UMI"
  }
  if (data_type == "reads"){
    align_UMI_tools_df_long <- process_folder_files(align_UMI_tools_read_folder) #Add threshold df if thresholds should be applied
    data_name <- "Read"
  } 
  ...
  p <- ggplot(matched_df, aes(x = diff)) +
    ...
    labs(title = paste("Distribution of",data_name, addage, "Count Differences (bcwithqc - align_UMI_tools)"),
...
compare_bcwithqc_align_UMI_tools("reads",
                   bcwithqc_function = process_bcwithqc_data_backup)
compare_bcwithqc_align_UMI_tools("umis",
                   bcwithqc_function = process_bcwithqc_rf_data,
                   bcwithqc_dir = bcwithqc_rf_folder)
compare_bcwithqc_align_UMI_tools("umis",
                   align_UMI_tools_umi_folder = "/g/steinmetz/link/Amplicon_barcode_analysis/NB_EXP030/dedup_no_filt/",
                   bcwithqc_function = process_bcwithqc_data_backup,
                   addage = "#NoFilter")
